...
private:
	...
	//You need a boolean pastTheEnd (see lecture video)
...
template <typename T>
bool Iterator<T>::operator!=(const Iterator<T>& itr) const
{

	return !(this->node == itr.node && this->pastTheEnd == itr.pastTheEnd);
